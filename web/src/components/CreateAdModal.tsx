...
// import * as Select from "@radix-ui/react-select" Desafio Radix Select (qual game)
                        ...
                        return <option key={game.id} value={game.id}>{game.title}</option>
									...
									<div className="grid grid-cols-2 gap-6">
										...
										<div className="flex flex-col gap-2">
											...
											<Input type="text" name="discord" id="discord" placeholder="Usuario#9999"/>
										</div>
									</div>
                             ...
                             S
										...
										<div className="flex flex-col gap-2 flex-1">
											...
											<div className="grid grid-cols-2 gap-2">
												...
												<Input type="time" id="hourStop" name="hourStop" placeholder="Ate"/>
											</div>
										</div>
									</div>
